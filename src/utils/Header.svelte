...
<header>
    <nav class="bg border-gray-200 dark:bg-gray-900 bg-orange-100">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            {#if $logInStatus}
              ...
              <li>
                <button class = "btn btn-md bg-transparent font-bold" href = "/users/login" on:click = {logOut}>Log Out</button>
              </li>
            {:else}
              <li>
